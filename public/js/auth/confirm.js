		...
		theUser.linkWithPopup(googleProvider).then(() => {
			theUser.updateProfile({
				...
				if (window.innerWidth > 870) {
					emailInvoice.style.marginTop = '16vh';
				} else if(window.innerWidth >= 821) {
					emailInvoice.style.marginTop = '22vh';
				} else if(window.innerWidth >= 500) {
					emailInvoice.style.marginTop = '19vh';
				} else if(window.innerWidth >= 400) {
					emailInvoice.style.marginTop = '18vh';
				} else if(window.innerWidth >= 381) {
					emailInvoice.style.marginTop = '17vh';
				} else if(window.innerWidth >= 374) {
					emailInvoice.style.marginTop = '13vh';
				}
			});
		}).catch(error => {
	...
	auth.currentUser.linkWithCredential(credential)
		.then(() => {
			auth.currentUser.updateProfile({
				...
				if (window.innerWidth > 870) {
					phoneInvoice.style.marginTop = '16vh';
				} else if(window.innerWidth >= 821) {
					phoneInvoice.style.marginTop = '22vh';
				} else if(window.innerWidth >= 500) {
					phoneInvoice.style.marginTop = '19vh';
				} else if(window.innerWidth >= 400) {
					phoneInvoice.style.marginTop = '18vh';
				} else if(window.innerWidth >= 381) {
					phoneInvoice.style.marginTop = '17vh';
				} else if(window.innerWidth >= 374) {
					phoneInvoice.style.marginTop = '13vh';
				}
			});
		})
		.catch(error => {
